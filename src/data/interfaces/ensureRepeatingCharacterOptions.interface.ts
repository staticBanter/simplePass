/**
 * Interface object that represents the 'Ensure Repeating Characters Option' object.
 *
 ...
 * @property {string|Array<Array<string>>} - A string input containing characters that should be repeated in the password.
...
interface I_ensureRepeatingCharacterOptions {
    repeatingSetCount?:number,
    customCharacterSet?:string|Array<Array<string>>,
    preservations?:I_repeatingCharacterOptionsPreservations
}
