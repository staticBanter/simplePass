'use strict';
/**
 * @file Configurable settings for simplePass.
 * @module config
 */
...
const config:{
    ...
    excludeCharactersMin:number,
    excludeCharactersMax:number,
    defaultPasswordLength:number,
    possibleWhitespaceCharacterOffset:number,
    whitespaceBetweenMax:(()=>number),
    whitespaceBetweenMin:(()=>number),
    ...
    "whitespaceBetweenMax":function():number{
    ...
    "whitespaceBetweenMin":function():number{
        const possibleWhitespaceCharacters = (this.passwordLengthMax - this.possibleWhitespaceCharacterOffset);
