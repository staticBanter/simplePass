...
import passwordModifier from "../interfaces/passwordModifier.interface";
...
const passwordPreConfigs:{
    ...
    default?:passwordModifier
    fourDigitPin?:passwordModifier,
    defaultSupplement1?:passwordModifier
    extreme?:passwordModifier
} = {
    default:{
        length:22,
        numbers:true,
